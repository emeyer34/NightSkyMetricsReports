...
:::{custom-style="sr Figure caption"}
Figure 2: A typical National Park Service Night Skies Program camera system consists of a commercial lens, a V-band filter, and a CCD camera. The camera system is mounted on a motorized mount, hooked up to external batteries, and controlled by a computer. NPS / NSNSD
:::
...
:::{custom-style="sr Figure caption"}
Figure 3. Panoramic image of the night sky from the `r (soi)` site on `r (soidate)`. The grid lines are spaced 30$^\circ$ apart. The observed sky shows light from all sources, both natural and artificial. NPS / NSNSD
:::
...
ft5 <- compose(ft5, i = 1, j = 6, part = "header", value = as_paragraph("SQM", "\n (mag/arcsec", as_sup("2"), ")"))
...
:::{custom-style="sr Figure caption"}
Figure 5. A model of average all-sky light pollution ratio (ALR) in the region surrounding `r (park)`. The park boundary is outlined in green. NPS / NSNSD  
:::
