...
packages = c("EnvStats", "reshape2",
             ...
             "kableExtra","statip","magrittr","flextable","officedown", "officer","forstringr","geojsonsf","sf")
...
zenskyb<-round(ave(as.numeric(repdata$ZENITH_LUM_MSA)),digits=2)
```
