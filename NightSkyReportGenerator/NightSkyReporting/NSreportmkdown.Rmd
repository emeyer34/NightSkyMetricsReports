...
# AVE sqm; step by step to remove NA and still average
# Step 1: Replace blank strings with NA
repdata$SQM[repdata$SQM == ""] <- NA
# Step 2: Convert to numeric, forcing non-numeric to become NA
repdata$SQM <- as.numeric(as.character(repdata$SQM))
# Step 3: Calculate the mean while excluding NA values
