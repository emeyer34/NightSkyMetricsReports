...
```{r nightreports, echo=FALSE,results ='asis'}

cat(paste("Dinosaur National Monument Example: https://irma.nps.gov/DataStore/DownloadFile/740932"))
cat("  \n")
cat(paste("NSNSD Night Sky Metrics Reports Data Collection Series: https://irma.nps.gov/DataStore/Collection/Profile/9562"))
```
